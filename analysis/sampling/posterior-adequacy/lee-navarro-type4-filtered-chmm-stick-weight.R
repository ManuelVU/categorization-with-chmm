...
lee_navarro <- readr::read_csv(
  file = "data/csv-files/lee-navarro-2002-type4-filtered-example.csv")
...
source(file = 
         "src/sampling-f/single-rate-interaction/posterior-adequacy-sampler.R")
